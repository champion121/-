...
<body>
	<div id="content">
		...
		<table width="100%" cellspacing="0" cellPadding="0" id="listTable">
			<thead>
				<tr>
					<td class="title" colspan="2">更新讲师</td>
				</tr>
			</thead>
			<form th:action="@{/teacher/update}" th:object="${teacherDto}"
				method="post" id="form">
				<input type="hidden" name="id" th:value="*{id}" />
				<tr>
					<td class="rightTd"><label for="teacher_name">姓名:</label></td>
					<td class="leftTd"><input id="teacher_name" type="text"
						th:value="*{teacher_name}" name="teacher_name"
						placeholder="请输入讲师名称"   vblur="true" vnotnull="true"  vnotnullText="* 讲师姓名不能为空" /><span></span></td>
				</tr>
				<tr>
					<td class="rightTd"><label for="sex">性别:</label></td>
					<!-- 判断当前是男还是女,是男就默认选择男 -->
					<td class="leftTd" th:if="${teacherDto.sex  == '男' }"><input
						type="radio" name="sex" value="男" checked="checked" />男<input
						type="radio" name="sex" value="女" />女</td>
					<td class="leftTd" th:if="${teacherDto.sex  == '女' }"><input
				...
				<tr>
					...
					<td class="leftTd"><input id="phone" type="text" name="phone"
						th:value="*{phone}" placeholder="请输入联系电话" vblur="true" vphone="true" vphoneText="* 请输入正确的电话号码" vnotnull="true" vnotnullText="* 电话号码不能为空" /><span></span></td>
				</tr>
				<tr>
					<td class="rightTd"><label for="email">Email:</label></td>
					<td class="leftTd"><input id="email" type="text" name="email"
						th:value="*{email}" placeholder="请输入电子邮箱" vblur="true"  vemail="true"  vemailText="* 请输入正确的邮箱"  vnotnull="true" vnotnullText="* 邮箱不能为空"  /><span></span></td>
				</tr>
				<tr>
					<td class="rightTd"><label for="salary">薪水:</label></td>
					<td class="leftTd"><input id="salary" type="text"
						name="salary" th:value="*{salary}" placeholder="请输入薪水" vblur="true" vnotnull="true"  vnotnullText="* 薪水不能为空" /><span></span></td>
				</tr>
				<tr>
					<td class="rightTd"><label for="dept_type">所属部门:</label></td>
					<td class="leftTd"><input id="dept_type" type="text" readonly="readonly"
						 th:value="*{dept_type}" placeholder="请选择部门" vnotnull="true"  vnotnullText="* 请选择部门" /><input type="hidden"  th:value="*{dept_id}"  id="dept_id" name="dept_id" /><span></span></td>
				...
				<tr>
					...
					<td class="leftTd"><input id="createDate" type="text"
						...
						placeholder="请输入入职时间" vnotnull="true"  vnotnullText="* 请选择入职时间"  /><span></span></td>
				</tr>
				<tr>
					<td class="centerTd" colspan="2" width="200px"><input id="submitBtn"
						type="button" value="更新讲师" /> <input type="reset" value="重置" />
					</td>
				</tr>
			</form>
		</table>
